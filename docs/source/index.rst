...
Welcome to GradingAutomation's documentation. This tool helps automate the grading process for Canvas 567 - DTC .
...
#. A Quiz with questions and answers named ``quiz.json``
#. A Team Information Form detailing team members, team name, and Topic named ``team_info.yml``
